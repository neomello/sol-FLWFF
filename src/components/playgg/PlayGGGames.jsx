    ...
    <div className="container">
      <div className={styles['playgg-games']}>
        ...
        <div className={styles['playgg-games__grid']}>
          ...
          <Game logo={genopets} url="https://www.genopets.me/" name="Genopets" />
          <Game logo={staratlas} url="https://staratlas.com/" name="Star Atlas" />
          <Game logo={honeyland} url="https://honey.land/countdown/" name="Honeyland" />
          <Game
          ...
          />
          <Game logo={caveworld} url="https://www.caveworld.com/" name="Cave World" />
          <Game
            logo={reignoftitans}
            url="https://twitter.com/ReignOfTitansGG"
            name="Reign of Titans"
          />
          <Game logo={bmc} url="https://twitter.com/BMCGamesPortal" name="BMC" />
          <Game logo={monkeyleague} url="https://www.monkeyleague.io/" name="Monkey League" />
          <Game logo={angelic} url="https://www.angelicthegame.com/" name="Angelic" />
          <Game logo={nowayback} url="https://nwb.gg/" name="No Way Back" />
          <Game logo={evio} url="https://ev.io/" name="ev.io" />
          <Game logo={bladerite} url="https://www.theseeds.io/" name="Bladerite" />
          <Game logo={miniarena} url="https://www.br1game.com/" name="Mini Arena" />
          <Game logo={mirrorworld} url="https://mirrorworld.fun/" name="Mirror World" />
          <Game logo={solcraft} url="https://solcraft.online/" name="Solcraft" />
          <Game logo={astrospace} url="https://astro-space.xyz/" name="Astro Space" />
          <Game logo={portals} url="https://theportal.to/" name="Portals" />
          <Game logo={moddio} url="https://www.modd.io/" name="Moddio" />
          <Game logo={photofinishlive} url="https://photofinish.live/" name="Photo Finish Live" />
          <Game logo={milliononmars} url="https://www.milliononmars.com/" name="Million on Mars" />
          <Game
            logo={dripdroparena}
            url="https://twitter.com/drippieverse"
            name="Drip Drop Arena"
          />
          <Game logo={royalechess} url="https://www.royalechess.com/" name="Royale Chess" />
          <Game logo={tinies} url="https://launcher.elixir.app/games/tinies" name="Tinies" />
          <Game
          ...
          />
          <Game logo={laddercaster} url="https://www.laddercaster.com/" name="Laddercaster" />
          <Game logo={abysswalkers} url="https://aw.grimsyndicate.com/" name="Abysswalkers" />
          <Game logo={projectelunne} url="https://www.projecteluune.com/" name="Project Elunne" />
          <Game logo={yesgnome} url="https://www.yesgnome.com/" name="Clash" />
          <Game logo={houseofparlay} url="https://houseofparlay.com/" name="House of Parlay" />
          <Game logo={lowlifeforms} url="https://twitter.com/lowlifeforms" name="Lowlife Forms" />
          <Game
            logo={megaroad}
            url="https://magiceden.io/launchpad/fidelionnft"
            name="Mega Road (powered by Fidelion)"
          />
          <Game logo={pogdigital} url="https://www.pogdigital.com/" name="Pog Digital" />
        </div>
      </div>
    </div>
  );

  ...
  return (
    <div className="my-6">
      <div className={styles['nft-showdown-intro']}>
        ...
        />
        <div className="mb-6">
          <div className="mono section-title h6 fw-normal">{nft - showdown.intro.title}:</div>
        ...
        <div className="my-10 text-center">
          <Button to="/news/solana-nft-showdown-winners" variant="secondary" size="large" newTab>
            {nft - showdown.cta}
          </Button>
        </div>

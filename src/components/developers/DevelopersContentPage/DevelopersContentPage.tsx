...
export function HeroTitle({ record, baseHref }: { record: ContentRecord; baseHref?: string }) {
  return (
    <section id="hero" className={classNames('row mb-8', styles['developers-content-page'])}>

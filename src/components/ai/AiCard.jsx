...
export default function AiCard() {
  return (
    <section className="container my-12 py-md-10">
      ...
      <RoundedDepthCard className={classNames(styles['card'], 'px-8 pt-8 pb-5')}>
        <h3 className={classNames(styles['card__title'], 'h2')}>{ai.card.title}</h3>
      ...
      <RoundedDepthCard className={classNames(styles['card'], 'px-8 pt-8 pb-5')}>
        <h3 className={classNames(styles['card__title'], 'h2')}>{ai.hackathon.title}</h3>
        ...
        <div className={classNames(styles['card__content'], 'my-5')}>
          <div className="d-flex flex-column flex-md-row justify-content-between align-md-items-center">
            ...
            <Link href="https://www.solanaagentkit.xyz/?ref=solana.com/ai" target="_blank">
              <Image src={sendAIhackathon} alt={ai.hackathon.title} height={100} />
            </Link>
          </div>
        </div>

...
const ECDRJoinCommunity = () => {
  return (
    <div className={classNames('mb-10 container', styles['ecdr-join-community'])}>
      <div className={styles['ecdr-join-community__signup']}>
        ...
        <p className={classNames('mt-5', styles['ecdr-join-community__signup--description'])}>
      ...
      <Link to="/grizzlython" className={styles['ecdr-join-community__background']}>

// @ts-check
import { BuilderAPIs, getEndpointsForBuilderAPI } from '@solana-foundation/solana-lib';
  ...
  inputs: [
    {
      ...
      subFields: [
        ...
        },
        {
          ...
          showIf: "options.getype === 'image' || options.getype === 'tall'",
        },
...
export const TrustbarConfig = {
  ...
  inputs: [
    ...
    },
    {
      name: 'eyebrow',
      type: 'text',
      defaultValue: 'Powering tools and integrations from companies all around the world',
...
export const ConversionPanelConfig = {
  ...
  inputs: [
    ...
    },
    {
      ...
      helperText: 'Will only showcase if the value of the variant is set to inline-centered',
    },
    {
      name: 'newsLetter',
      type: 'boolean',
...
export const HeroConfig = {
  ...
  inputs: [
    ...
    { name: 'centered', type: 'boolean', defaultValue: false },
    {
      ...
      helperText: 'Will only showcase if the value of the centered field is set to true',
    },
    {
      name: 'rightImage',
      type: 'object',
  ...
  inputs: [
    {
      name: 'url',
      type: 'text',
      defaultValue: 'https://www.youtube.com/watch?v=MQVa8Mgwygk&ab_channel=Solana',
    },
  ],
};
...
export const CodeBlockConfig = {
  ...
  inputs: [
    ...
    },
    {
      name: 'language',
      type: 'text',
      enum: ['jsx', 'typescript', 'tsx', 'rust', 'solidity', 'json', 'bash', 'latex'],
...
export const DetailsHeroConfig = {
  ...
  inputs: [
    ...
    },
    {
      ...
      helperText: 'The breadcrumbs for the hero section. The LAST one will not be clickable.',
    },
    {
      name: 'publishedDate',
      type: 'text',
      helperText: "The published date of the article or page. (e.g. '2021/02/25')",
    },
    {
      name: 'author',
      type: 'reference',
...
export const AccelerateHeroConfig = {
  ...
  inputs: [{ name: 'variant', type: 'string', enum: ['none', 'ship', 'scale'] }],
};

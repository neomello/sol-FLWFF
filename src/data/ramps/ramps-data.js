...
export const rampData = [
  {
    ...
    fields: {
      ...
      RampLogo: mercuryo,
      PaymentRails: ['apple-pay', 'google-pay', 'mastercard', 'pix', 'sepa', 'visa'],
      FiatAssets: [
        'AUD',
        'BGN',
        'BRL',
  ...
  },
  {
    ...
    fields: {
      ...
      RampLogo: payfura,
      PaymentRails: ['7-eleven', 'banco-do-brasil', 'oxxo', 'picpay', 'pix', 'spei'],
      FiatAssets: ['BRL', 'MXN'],
      Countries: ['brazil', 'mexico'],
      RampStatusOn: false,
      RampStatusOff: false,
  ...
  },
  {
    ...
    fields: {
      ...
      Countries: ['canada', 'european-union', 'united-kingdom', 'united-states'],
      RampStatusOn: true,
      RampStatusOff: true,
    },
  },
